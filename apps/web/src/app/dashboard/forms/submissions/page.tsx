...
const mockSubmissions: MockSubmission[] = [
  {
    ...
    data: {
      ...
      Phone: "(555) 123-4567",
      Message: "Need a quote for AC repair. Unit is blowing warm air.",
    },
  ...
  },
  {
    id: "sub-2",
    formId: "form-2",
    formName: "Free Quote Request",
    data: {
      Name: "Tom Baker",
      Email: "tombaker@email.com",
      Phone: "(555) 456-7890",
      "Service Needed": "HVAC",
      "Preferred Date": "03/25/2026",
      "Describe Your Issue": "Central AC not cooling the upstairs bedrooms",
    },
  ...
  },
  {
    ...
    data: {
      ...
      Phone: "(555) 234-5678",
      Message: "Furnace making strange clicking noise when starting up",
    },
  ...
  },
  {
    ...
    data: {
      ...
      "Preferred Date": "03/24/2026",
      "Describe Your Issue": "Leaking kitchen faucet, dripping constantly",
    },
  ...
  },
  {
    id: "sub-5",
    formId: "form-3",
    formName: "Emergency Service Request",
    data: {
      Name: "Dave Wilson",
      Phone: "(555) 678-9012",
      Address: "123 Oak St, Springfield",
      "Emergency Type": "Water Leak",
      Details: "Pipe burst in basement, water everywhere",
    },
  ...
  },
  {
    ...
    data: {
      ...
      Phone: "(555) 345-6789",
      Message: "Want to schedule annual HVAC maintenance for two units",
    },
  ...
  },
  {
    id: "sub-7",
    formId: "form-4",
    formName: "Seasonal Tune-Up Signup",
    data: {
      Name: "Karen Price",
      Email: "karenp@email.com",
  ...
  },
  {
    ...
    data: {
      ...
      Phone: "(555) 789-0123",
      "Service Needed": "Electrical",
      "Preferred Date": "03/28/2026",
      "Describe Your Issue":
        "Need new electrical panel installed, current one is outdated",
    },
    submittedAt: "2026-03-19T13:45:00Z",
    source: "Landing Page",
    contactCreated: true,
  },
  {
    ...
    data: {
      ...
      "Emergency Type": "Gas Smell",
      Details: "Strong gas smell near water heater, evacuated house",
    },
    submittedAt: "2026-03-18T19:30:00Z",
    source: "Popup",
    contactCreated: true,
  },
  {
