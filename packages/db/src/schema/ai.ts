...
export const aiAgents = pgTable(
  "ai_agents",
  {
    ...
    geminiConfig: jsonb("gemini_config").default({}).notNull(),
...
export const aiCallLogs = pgTable(
  "ai_call_logs",
  {
    ...
    audioDurationInMs: integer("audio_duration_in_ms").default(0),
    audioDurationOutMs: integer("audio_duration_out_ms").default(0),
    textTokensIn: integer("text_tokens_in").default(0),
    textTokensOut: integer("text_tokens_out").default(0),
